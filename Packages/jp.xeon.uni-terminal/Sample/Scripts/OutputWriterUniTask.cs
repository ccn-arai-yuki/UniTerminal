...
namespace Xeon.UniTerminal.Sample
{
    ...
    /// </summary>
    public class OutputWriterUniTask : IUniTaskTextWriter
    {
        ...
        public OutputWriterUniTask(CircularBuffer<OutputData> buffer, bool isError = false, Func<int> getMaxCharsPerLine = null)
        {
            this.buffer = buffer;
